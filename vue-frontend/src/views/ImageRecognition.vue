  ...
  <div class="img-container">
    ...
    <div class="main-section">
      ...
      <div class="top-bar">
        ...
        <span class="top-title">AI 图像识别助手</span>
      </div>
    ...
    const handleSubmit = async () => {
      ...
      try {
        ...
        if (response.data && response.data.class_name) {
          ...
          messages.value.push({
            role: 'assistant',
            content: `识别失败：${response.data.status_msg || '未知错误'}`
          })
        }
      } catch (error) {
...
.file-label.has-file {
  border-color: rgba(94,223,255,.3);
  color: #5edfff;
  border-style: solid;
